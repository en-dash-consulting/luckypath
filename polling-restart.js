 ...
 */
import { suspendAllSources, resumeAllSources, } from "./polling-state.js";
import { onDegradationChange, isFeatureDisabled, } from "./graceful-degradation.js";
// ─── Module state ────────────────────────────────────────────────────────────
let unsubscribeDegradation = null;
let started = false;
/**
...
// ─── Internal handler ────────────────────────────────────────────────────────
function handleDegradationChange(state) {
 ...
 */
export function startPollingRestart() {
    if (started)
        stopPollingRestart();
    started = true;
    coordinatorSuspended = false;
 ...
 */
export function stopPollingRestart() {
 ...
 */
export function isPollingRestartStarted() {
    return started;
}
/**
 * Check if the coordinator has triggered a global suspension.
 */
export function isCoordinatorSuspended() {
    return coordinatorSuspended;
}
/**
 * Reset all module state (for testing).
 */
export function resetPollingRestart() {
    stopPollingRestart();
    started = false;
    coordinatorSuspended = false;
}
//# sourceMappingURL=polling-restart.js.map