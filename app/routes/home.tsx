  ...
  return (
    <div className="min-h-dvh bg-gradient-to-b from-green-100 via-emerald-50 to-amber-50/50 flex flex-col items-center justify-center p-6 pb-20 select-none">
      ...
      <a
        ...
        className="absolute bottom-6 flex items-center gap-2.5 opacity-50 hover:opacity-80 transition-opacity"
      >
        <svg width="20" height="20" viewBox="0 0 330 330" fill="none">
        ...
        <span className="text-sm text-gray-600 font-medium">Built by En Dash</span>
      </a>
    </div>
  );
}
