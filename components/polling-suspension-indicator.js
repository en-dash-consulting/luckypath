...
export function PollingSuspensionIndicator({ isSuspended, suspendedCount, onRefresh, }) {
    if (!isSuspended)
        return null;
    const detail = suspendedCount === 1
    ...
    h("div", { class: "polling-suspension-info" }, h("span", { class: "polling-suspension-title" }, "Auto-refresh paused"), h("span", { class: "polling-suspension-detail" }, `${detail} \u2014 memory pressure`)), h("button", {
...
//# sourceMappingURL=polling-suspension-indicator.js.map