...
export function SvFreshnessIndicator({ status, onNavigate, tabIndex }) {
    if (status.freshness === "unavailable") {
        ...
        }, h("span", { class: "indicator-dot indicator-dot-unavailable", "aria-hidden": "true" }), h("span", { class: "indicator-text" }, "No analysis"));
    }
    ...
    return h("div", {
        ...
        "aria-hidden": "true",
    }), h("span", { class: "indicator-text" }, isStale ? `Stale (${timeLabel})` : `Fresh (${timeLabel})`));
}
export function RexCompletionIndicator({ status, onNavigate, tabIndex }) {
    if (!status.exists) {
        return h("div", {
            class: "sidebar-indicator sidebar-indicator-warning",
            role: "status",
            "aria-label": "No PRD data",
        }, h("span", { class: "indicator-dot indicator-dot-unavailable", "aria-hidden": "true" }), h("span", { class: "indicator-text" }, "No PRD"));
    }
    ...
    h("div", { class: "indicator-row" }, h("span", { class: "indicator-pct" }, `${percentComplete}%`), h("span", { class: "indicator-meta" }, total > 0
        ? `${completed}/${total}`
        : "empty"), hasInProgress
        ...
        : null), 
    // Progress bar
    h("div", { class: "indicator-bar", role: "progressbar", "aria-valuenow": String(percentComplete), "aria-valuemin": "0", "aria-valuemax": "100" }, h("div", {
        class: `indicator-fill ${barClass}`,
        style: `width: ${percentComplete}%`,
    })), 
    // Next task hint (if available)
    nextTaskTitle
        ? h("div", { class: "indicator-next", title: nextTaskTitle }, h("span", { class: "indicator-next-label" }, "Next: "), nextTaskTitle)
        : null);
}
export function HenchActivityIndicator({ status, onNavigate, tabIndex }) {
    if (!status.configured) {
        return h("div", {
            class: "sidebar-indicator sidebar-indicator-warning",
            role: "status",
            "aria-label": "Hench not configured",
        }, h("span", { class: "indicator-dot indicator-dot-unavailable", "aria-hidden": "true" }), h("span", { class: "indicator-text" }, "Not configured"));
    }
