...
export function BarChart({ data, width = 500, height }) {
    if (data.length === 0)
        return null;
    const barHeight = 22;
    const gap = 4;
...
export function FlowDiagram({ nodes, edges, onNodeClick, }) {
    if (nodes.length === 0)
        return null;
    ...
    return h("div", { class: "flow-diagram" }, h("svg", {
...
//# sourceMappingURL=mini-charts.js.map