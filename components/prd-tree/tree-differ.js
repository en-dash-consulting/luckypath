...
function itemShallowEqual(a, b) {
    ...
    if (!arraysEqual(a.blockedBy, b.blockedBy))
        return false;
    // Compare acceptanceCriteria arrays
    if (!arraysEqual(a.acceptanceCriteria, b.acceptanceCriteria))
        return false;
    return true;
}
 ...
 */
export function diffDocument(prev, next) {
    if (!prev)
        return next;
