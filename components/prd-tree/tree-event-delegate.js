 ...
 */
export function useTreeEventDelegation(cb) {
    ...
    const onClick = useCallback((e) => {
        ...
        if (target.closest(".prd-node-action-status")) {
            if (c.onStatusClick) {
                const btn = target.closest(".prd-node-action-status");
...
//# sourceMappingURL=tree-event-delegate.js.map