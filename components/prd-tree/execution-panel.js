...
// ── Component ────────────────────────────────────────────────────────
export function ExecutionPanel({ onPrdChanged }) {
    ...
    const [autoRefreshDisabled, setAutoRefreshDisabled] = useState(() => isFeatureDisabled("autoRefresh"));
    useEffect(() => {
    ...
    const statusPipeline = useRef(createFetchPipeline(async () => {
    ...
    return h("div", { class: "exec-panel" }, h("div", { class: "exec-panel-header" }, h("h3", { class: "exec-panel-title" }, "Epic-by-Epic Execution"), isActive
        ? h("span", {
    ...
    isIdle
        ? h("div", { class: "exec-panel-idle" }, h("p", { class: "exec-panel-desc" }, "Execute all epics sequentially. Each epic's tasks will be processed by the hench agent before moving to the next."), h("button", {
    ...
    isActive
        ...
        // Overall progress
        h("div", { class: "exec-panel-progress" }, h("div", { class: "exec-panel-progress-header" }, h("span", { class: "exec-panel-progress-label" }, `Epic ${Math.min(status.currentEpicIndex + 1, status.totalEpics)} of ${status.totalEpics}`), h("span", { class: "exec-panel-progress-pct" }, `${status.percentComplete}%`)), h("div", {
        ...
        })), h("span", { class: "exec-panel-progress-detail" }, `${status.completedTasks}/${status.totalTasks} tasks completed`)), 
        // Controls
        h("div", { class: "exec-panel-controls" }, status.status === "running"
            ? h("button", {
        ...
        // Epic list
        h("div", { class: "exec-panel-epic-list" }, ...status.epics.map((epic) => h("div", {
            key: epic.id,
            class: [
                "exec-panel-epic",
        ...
        }, h("div", { class: "exec-panel-epic-row" }, h("span", {
            class: `exec-panel-epic-icon exec-panel-epic-icon-${epic.status}`,
            "aria-label": EPIC_STATUS_LABELS[epic.status] ?? epic.status,
        }, EPIC_STATUS_ICONS[epic.status] ?? "○"), h("span", { class: "exec-panel-epic-title", title: epic.title }, epic.title), h("span", { class: "exec-panel-epic-count" }, `${epic.tasksCompleted}/${epic.tasksTotal}`)), epic.tasksTotal > 0
            ? h("div", { class: "exec-panel-epic-bar" }, h("div", {
    ...
    isDone
        ? h("div", { class: "exec-panel-done" }, h("div", { class: "exec-panel-summary" }, status.status === "completed"
            ? h("span", { class: "exec-panel-summary-icon exec-panel-summary-success" }, "✓")
            : h("span", { class: "exec-panel-summary-icon exec-panel-summary-fail" }, "✕"), h("span", null, status.status === "completed"
        ...
        status.epics.length > 0
            ? h("div", { class: "exec-panel-epic-list" }, ...status.epics.map((epic) => h("div", {
                ...
                class: `exec-panel-epic-icon exec-panel-epic-icon-${epic.status}`,
            }, EPIC_STATUS_ICONS[epic.status] ?? "○"), h("span", { class: "exec-panel-epic-title", title: epic.title }, epic.title), h("span", { class: "exec-panel-epic-count" }, `${epic.tasksCompleted}/${epic.tasksTotal}`)))))
            : null, 
        // Restart button
        h("button", {
...
//# sourceMappingURL=execution-panel.js.map