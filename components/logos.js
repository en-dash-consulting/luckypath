...
export function NdxLogoPng({ size = 36, class: cls }) {
    return h("img", {
        src: "/n-dx.png",
        width: size,
        height: size,
...
export function ProductLogoPng({ product, size = 20, class: cls }) {
...
export function BrandedHeader({ product, title, class: cls }) {
    return h("div", { class: `branded-header${cls ? ` ${cls}` : ""}` }, h(ProductLogoPng, { product, size: 16, class: "branded-header-logo" }), h("span", { class: "branded-header-label" }, title));
}
