...
import { useProjectStatus, SvFreshnessIndicator, RexCompletionIndicator, HenchActivityIndicator, } from "./status-indicators.js";
...
const NAV_ENTRIES = [
    ...
    ...SOURCEVISION_TABS.map((tab) => ({ type: "item", ...tab })),
...
function getInitialExpanded(view) {
...
export function Sidebar({ view, onNavigate, manifest, zones, sidebarCollapsed, onToggleSidebar, scope }) {
    ...
    const [expandedSection, setExpandedSection] = useState(() => scope ? (visibleSections[0]?.label ?? getInitialExpanded(view)) : getInitialExpanded(view));
    ...
    const completedCount = moduleNames.filter((m) => modules[m]?.status === "complete").length;
    ...
    useEffect(() => {
        ...
        setExpandedSection((prev) => {
            if (prev === owning)
                return prev;
            try {
                localStorage.setItem(STORAGE_KEY, owning);
            }
            catch { /* noop */ }
            return owning;
        });
    ...
    sidebarCollapsed
        ...
        h("div", {
            ...
            onKeyDown: (e) => {
                if (e.key === "Enter" || e.key === " ") {
                    e.preventDefault();
                    handleNav(visibleSections[0]?.items[0]?.id ?? "overview");
                }
            },
        }, scope
            ? h(ProductLogoPng, { product: scope, size: 48 })
            : h(NdxLogoPng, { size: 48 })), h("div", { class: "sidebar-rail-divider", "aria-hidden": "true" }), 
        // Section icons
        h("nav", { class: "sidebar-rail-nav", "aria-label": "Section navigation" }, visibleSections.filter((s) => s.product).map((section) => {
            ...
            return h("button", {
                ...
                : null, h(ProductLogoPng, { product, size: 48, class: "sidebar-rail-icon" }));
        })), 
        ...
        }, h("svg", { width: 16, height: 16, viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", "stroke-width": "1.5", "stroke-linecap": "round" }, h("path", { d: "M5 2l6 6-6 6" }))))
        : null, h("div", { class: "sidebar-header" }, h("div", { class: "sidebar-brand" }, scope
        ? h(ProductLogoPng, { product: scope, size: 36, class: "sidebar-logo" })
        : h(NdxLogoPng, { size: 20, class: "sidebar-logo-sm" }), h("div", { class: "sidebar-brand-text" }, 
    ...
    scope
        ...
        : h("div", { class: "sidebar-subtitle" }, "n-dx"))), h("button", {
        class: "mobile-menu-btn",
        onClick: () => setMobileOpen(!mobileOpen),
        "aria-label": mobileOpen ? "Close menu" : "Open menu",
        "aria-expanded": String(mobileOpen),
    }, mobileOpen ? "\u2715" : "\u2630")), h("nav", { class: "sidebar-nav", "aria-label": "View navigation" }, visibleSections.map((section) => {
        ...
        h("div", {
            ...
            : null, h("span", { class: "nav-section-label" }, section.label), h("svg", {
        ...
        h("div", {
            ...
            }, h("span", { class: "nav-icon", "aria-hidden": "true" }, entry.icon), entry.label, locked
        ...
        section.product === "sourcevision" && manifest
            ...
            }, h("div", { class: "progress-label" }, `Analysis: ${completedCount}/${moduleNames.length}`), h("div", { class: "progress-bar", role: "progressbar", "aria-valuenow": String(completedCount), "aria-valuemin": "0", "aria-valuemax": String(moduleNames.length) }, h("div", {
                class: "progress-fill",
                style: `width: ${(completedCount / moduleNames.length) * 100}%`,
            })), h("div", { class: "progress-modules" }, moduleNames.map((m) => {
    ...
    !sidebarCollapsed
        ? h("div", { class: "sidebar-footer", role: "group", "aria-label": "Sidebar controls" }, h("div", { class: "sidebar-footer-divider", "aria-hidden": "true" }), h(ConfigFooter, null), h("div", { class: "sidebar-footer-divider", "aria-hidden": "true" }), h("div", { class: "sidebar-footer-controls" }, h(SidebarThemeToggle, null), h(GlobalFAQ, null), h("button", {
            class: "sidebar-control-btn sidebar-collapse-btn",
            onClick: onToggleSidebar,
            title: "Collapse sidebar (\u2318B)",
            "aria-label": "Collapse sidebar",
        }, h("svg", { width: 14, height: 14, viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", "stroke-width": "1.5", "stroke-linecap": "round" }, h("path", { d: "M11 2L5 8l6 6" })))))
        : null, 
    // Mobile backdrop
    mobileOpen
        ? h("div", {
