...
export function MemoryWarningBanner({ snapshot, level, visible, onDismiss, }) {
    if (!visible || (level !== "warning" && level !== "critical"))
        return null;
    ...
    return h("div", {
        ...
        role: "alert",
        "aria-live": "assertive",
    }, h("div", { class: "memory-warning-content" }, h("span", { class: "memory-warning-icon", "aria-hidden": "true" }, cfg.icon), h("div", { class: "memory-warning-text" }, h("strong", null, cfg.label), h("span", { class: "memory-warning-detail" }, ` — ${ratio} of heap used (${used} / ${limit})`), h("p", { class: "memory-warning-advice" }, cfg.advice)), h("button", {
...
//# sourceMappingURL=memory-warning.js.map