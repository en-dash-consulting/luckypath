...
export function ThrottleControlsPanel() {
    ...
    // ── Handlers ───────────────────────────────────────────────────────
    const handleConcurrencyChange = useCallback(async (value) => {
    ...
    // Header
    h("div", { class: "throttle-header" }, h("div", { class: "throttle-header-left" }, h("span", {
        class: `throttle-icon${paused ? " throttle-icon-paused" : ""}`,
        "aria-hidden": "true",
    }, paused ? "⏸" : "⚙"), h("h3", { class: "throttle-title" }, "Throttle Controls"), paused
        ? h("span", { class: "throttle-paused-badge" }, "Paused")
        : null), activeExecutions > 0
        ? h("span", { class: "throttle-active-count" }, `${activeExecutions} active`)
        : null), 
    // Error display
    error
        ...
        : null, 
    // Concurrency slider
    h("div", { class: "throttle-section" }, h("div", { class: "throttle-section-header" }, h("span", { class: "throttle-section-label" }, "Concurrency Limit"), h("span", { class: "throttle-section-value" }, hasOverride
        ? h("span", null, h("span", { class: "throttle-override-value" }, String(effectiveMaxConcurrent)), h("span", { class: "throttle-config-hint" }, ` (config: ${configMaxConcurrent})`))
        : String(effectiveMaxConcurrent))), h("div", { class: "throttle-slider-row" }, h("span", { class: "throttle-slider-min" }, "1"), h("input", {
        type: "range",
    ...
    }), h("span", { class: "throttle-slider-max" }, "10")), hasOverride
        ? h("button", {
    ...
    h("div", { class: "throttle-section" }, h("div", { class: "throttle-section-header" }, h("span", { class: "throttle-section-label" }, "New Executions"), h("span", {
        class: `throttle-status-indicator${paused ? " throttle-status-paused" : " throttle-status-active"}`,
    }, paused ? "Paused" : "Accepting")), paused
        ? h("div", { class: "throttle-pause-info" }, h("p", { class: "throttle-pause-desc" }, "New task executions are blocked. Running tasks continue until they finish."), pausedAt
    ...
    // Emergency stop
    h("div", { class: "throttle-section throttle-section-danger" }, h("div", { class: "throttle-section-header" }, h("span", { class: "throttle-section-label throttle-danger-label" }, "Emergency Stop")), showStopConfirm
        ? h("div", { class: "throttle-stop-confirm" }, h("p", { class: "throttle-stop-warn" }, `This will terminate ${activeExecutions} running execution${activeExecutions !== 1 ? "s" : ""} and pause new ones. Are you sure?`), h("div", { class: "throttle-stop-actions" }, h("button", {
            class: "throttle-stop-confirm-btn",
            onClick: handleEmergencyStop,
            disabled: loading === "stop",
            "aria-label": "Confirm emergency stop",
        }, loading === "stop" ? "Stopping…" : "⚠ Confirm Stop All"), h("button", {
        ...
        : h("button", {
            ...
            : `⛔ Stop All Executions (${activeExecutions})`), lastEmergencyStopAt
        ? h("span", { class: "throttle-stop-last" }, `Last stop: ${timeAgo(lastEmergencyStopAt)}`)
        : null));
}
//# sourceMappingURL=throttle-controls.js.map