...
export function ConfigFooter() {
    ...
    }, AUTH_ICONS[config.authMethod])), h("svg", {
    ...
    expanded
        ...
        // Config rows
        h("div", { class: "config-row" }, h("span", { class: "config-label" }, "Model"), h("span", { class: "config-value" }, formatModel(config.model))), h("div", { class: "config-row" }, h("span", { class: "config-label" }, "Auth"), h("span", { class: "config-value" }, AUTH_LABELS[config.authMethod])), config.provider
            ? h("div", { class: "config-row" }, h("span", { class: "config-label" }, "Provider"), h("span", { class: "config-value" }, config.provider))
            : null, h("div", { class: "config-row" }, h("span", { class: "config-label" }, "Budget"), h("span", { class: "config-value" }, formatTokenBudget(config.tokenBudget))), config.maxTurns
            ? h("div", { class: "config-row" }, h("span", { class: "config-label" }, "Max turns"), h("span", { class: "config-value" }, String(config.maxTurns)))
            : null)
        : null);
}
//# sourceMappingURL=config-footer.js.map