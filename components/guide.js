...
export function Guide({ view }) {
    ...
    return h(Fragment, null, h("button", {
        ...
        ? h("div", { class: "guide-overlay", onClick: () => setOpen(false), role: "dialog", "aria-modal": "true", "aria-label": `Guide: ${content.title}` }, h("div", { class: "guide-modal", onClick: (e) => e.stopPropagation() }, h("div", { class: "guide-header" }, h("h2", null, content.title), h("button", { class: "guide-close", onClick: () => setOpen(false), "aria-label": "Close guide" }, "\u2715")), h("div", { class: "guide-body" }, h("section", null, h("h3", null, "What you're looking at"), h("p", null, content.description)), h("section", null, h("h3", null, "What to look for"), h("p", null, content.lookFor)), h("section", null, h("h3", null, "What actions to take"), h("p", null, content.actions)))))
        : null);
}
