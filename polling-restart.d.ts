 ...
 */
export declare function isPollingRestartStarted(): boolean;
/**
 * Check if the coordinator has triggered a global suspension.
 */
export declare function isCoordinatorSuspended(): boolean;
/**
 * Reset all module state (for testing).
 */
export declare function resetPollingRestart(): void;
