...
const RouteTreeNodeSchema = z.lazy(() => z.object({
    file: z.string(),
...
const ComponentsSummarySchema = z.object({
    ...
    mostUsedComponents: z.array(z.object({
        name: z.string(),
        file: z.string(),
        usageCount: z.number().int().positive(),
    })),
...
const CallGraphSummarySchema = z.object({
    ...
    mostCalled: z.array(z.object({
        qualifiedName: z.string(),
        file: z.string(),
        callerCount: z.number().int().positive(),
    })),
    mostCalling: z.array(z.object({
        qualifiedName: z.string(),
        file: z.string(),
...
export function validateImports(data) {
...
export function validateCallGraph(data) {
