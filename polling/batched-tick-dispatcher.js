 ...
 */
export function registerTickUpdater(compute, setDisplay, lastValueRef) {
    const reg = { compute, setDisplay, lastValueRef };
 ...
 */
export function getBatchedTickDispatcherState() {
    return {
 ...
 */
export function flushBatchedTicks() {
    if (rafId !== null) {
        cancelAnimationFrame(rafId);
        rafId = null;
    }
 ...
 */
export function resetBatchedTickDispatcher() {
    if (tickUnsub) {
        tickUnsub();
        tickUnsub = null;
    }
...
//# sourceMappingURL=batched-tick-dispatcher.js.map